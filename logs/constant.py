...
class Constant:
    LOG_START_DATE:datetime = datetime (year=2024, month=1, day = 1, hour=0, minute=0, second=0)
    LOG_END_DATE:datetime = datetime(year=2025, month=1, day = 1, hour=0, minute=0, second=0)
    NB_LOGS:int = 100000
    ...
    NUMBER_OF_ANOMAMLY_IPS:int=15
    LOGS_DATA_FILE_NAME:str="data/logs_dataset.csv"

    TRAIN_SET_RATION:float = 0.85
    TEST_SET_RATION:float = 0.25
